...
variable "mp_listing_id" {
  ...
  default = "ocid1.appcataloglisting.oc1..aaaaaaaa462do4bpg6lxfctzmcv7gzpd6hnupr5mu3gvlvxvumvl55c5d2qq"
}
...
variable "instance_image_id" {
  ...
  default = "ocid1.image.oc1..aaaaaaaaudzfj26es4qfq4rva3xtyjzopud6fnphwz3nc7uc3alyp655zinq"
}
...
variable "desktop_guide_url" {
  default = "https://oracle-livelabs.github.io/multicloud/weblogic-toolkit-ui-hpa/workshops/freetier/"
}

variable "desktop_app1_url" {
  default = "http://localhost:7001/console"
}

variable "desktop_app2_url" {
  default = "https://container-registry.oracle.com"
}
