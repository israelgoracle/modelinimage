...
output "workshop_desc" {
  value = format("Multi Labs Workshops Setup for Oracle WebLogic Kubernetes ToolKit UI on LiveLabs. Count of total instances provisioned: %s virtual machines of %s shape ",
    var.instance_count,
